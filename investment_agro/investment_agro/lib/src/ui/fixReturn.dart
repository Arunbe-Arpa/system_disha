...
class FixReturn extends StatefulWidget {
  const FixReturn({Key? key}) : super(key: key);

  @override
  _FixReturnState createState() => _FixReturnState();
}

class _FixReturnState extends State<FixReturn> {
  @override
              ...
              Expanded(
                child: Container(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance.collection("fixed-return").snapshots(),
