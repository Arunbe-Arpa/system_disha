...
class VariableReturn extends StatefulWidget {
  const VariableReturn({Key? key}) : super(key: key);

  @override
  _VariableReturnState createState() => _VariableReturnState();
}

class _VariableReturnState extends State<VariableReturn> {
  @override
              ...
              Expanded(
                child: Container(
                  ...
                  child: StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance.collection("variable-return").snapshots(),
